  ...
  return (
    <AlurakutMenu.Wrapper isMenuOpen={isMenuOpen}>
      <div className="container">
        <AlurakutMenu.Logo src="https://raw.githubusercontent.com/wmiguita/alurakut/main/public/images/heromunity-header.png" width="176" height="42"/>
...
`;
AlurakutMenu.Logo = styled(Image)`
...
const AlurakutLoginScreen = css`
  :root {
    ...
    --backgroundSecondary: #ee4266;
    --backgroundTertiary: #f3fcf0;
    --backgroundQuarternary: #560d6e;
    --backgroundFifth: #1f271b;
    --colorPrimary: #540d6e;
    --colorSecondary: #ffd23f;
    --colorTertiary: #1f271b;
    --colorQuarternary: #ee4266;
    --textPrimaryColor: #f3fcf0;
    --textSecondaryColor: #ffd23f;
    --textTertiaryColor: #1f271b;
    --textQuarternaryColor: #54d6e;
    --commonRadius: 8px;
  }
